...
function createOrderer() {
  ...
  # Copy orderer org's CA cert to orderer org's /msp/tlscacerts directory (for use in the channel MSP defi  mkdir -p "${PWD}/organizations/ordererOrganizations/example.com/msp/tlscacerts"
